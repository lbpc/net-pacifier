...
ES_QUERY_CMS_BRUTE = '(path:xmlrpc.php OR path:administrator.php OR path:wp-login.php OR path:admin OR path:wp-admin) AND method:POST AND NOT code:301 AND NOT remote_addr:"127.0.0.1"'
MIN_SCORE = 3
